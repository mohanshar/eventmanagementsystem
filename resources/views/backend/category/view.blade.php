                    ...
                    <table id="example" class="table table-centered table-striped dt-responsive nowrap w-100"
                        ...
                        <tbody id="tablecontents">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{route('edit.category',$site->id)}}" title="Edit"><i class="fa fa-edit "></i></a>
                                    <a href="{{route('delete.category',$site->id)}}" onclick="return confirm('Are you sure you want to delete?')"
